...
import com.simplesys.SmartClient.App.props.{CommonListGridEditorComponentProps, MenuItemType, SettingsEditorProps}
...
import com.simplesys.app.{ConstructorForm, _}
import com.simplesys.appCommon
import com.simplesys.function._
import com.simplesys.js.components.props._
...
import ru.simplesys.defs.app.scala.container.{PersistenceJournalMessageContainer, PersistenceJournal_DebugMessageContainer}
                                                ...
                                                (target: Canvas, item: MenuSSItem, menu: MenuSS, colNum: JSUndefined[Int]) =>
                                                    ...
                                                    val listItems = CommonListGridEditorComponent.create(
                                                        new CommonListGridEditorComponentProps {
                                                            ...
                                                            itemsType = Seq(MenuItemType.miDelete, MenuItemType.miEdit, MenuItemType.miRefresh).opt
                                                            customMenu = Seq(
                                                                MenuSSItem(
                                                                    new MenuSSItemProps {
                                                            ...
                                                            replacingFields = Seq(
                                                                ...
                                                                new ListGridFieldProps {
                                                                    ...
                                                                    import ru.simplesys.defs.app.gen.scala.ScalaJSGen.scenarios_ListElements_code_list_NameStrong

                                                                    nameStrong = scenarios_ListElements_code_list_NameStrong.opt
                                                                    hidden = true.opt
                                                                }
                                                            ).opt
                                                        }
                ...
                controls = Seq(
                    IconMenuButtonSS.create(
                        new IconMenuButtonSSProps {
                            ...
                            icon = appCommon.scenarioTets.opt
                ...
                controls = Seq(
                    IconMenuButtonSS.create(
                        new IconMenuButtonSSProps {
                            ...
                            icon = appCommon.scenarioTrace.opt
