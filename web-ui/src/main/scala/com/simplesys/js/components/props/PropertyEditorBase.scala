...
import com.simplesys.app.{CalcGroupItem, CounterAccumItem, FormItemList, GroupItem, LoggingItem, PropertyEditorDynamicForm, SendMessageItem, SubProgramItem, TimerItem, VariableItem}
import com.simplesys.function._
import com.simplesys.js.components.drawing.drawItems._
import com.simplesys.js.components.formItems.ScalaTypes
import com.simplesys.js.components.formItems.props._
import com.simplesys.js.components.validators.Validators
import com.simplesys.js.components.{MultiElementsValue, PropEditorLiveObject, TemplateObject}
                                            ...
                                            templateObject.getLists.foreach {
                                                drawItem ⇒
                                                    drawItem.listRefs.foreach {
                                                        listRefs ⇒
                                                            val _listRefs = listRefs.asInstanceOf[ListsDataRecord]

                                                            cacheData add DataSourceField(
                                                                new DataSourceFieldProps {
                                                                    name = _listRefs.code_list.opt
                                                                    `type` = FieldType.enum.opt
                                                                    title = s"${_listRefs.caption_list} Группа: ${_listRefs.caption_listGroup}".opt
