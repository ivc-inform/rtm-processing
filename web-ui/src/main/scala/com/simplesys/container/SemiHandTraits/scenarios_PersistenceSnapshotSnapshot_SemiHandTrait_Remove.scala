...
trait scenarios_PersistenceSnapshotSnapshot_SemiHandTrait_Remove extends SessionContextSupport with ServletActorDyn {
...
/////////////////////////////// !!!!!!!!!!!!!!!!!!!!!!!!!!!! DON'T MOVE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ///////////////////////////////    
    ...
    val dataSet = PersistenceSnapshotSnapshotDS(ds)    
/////////////////////////////// !!!!!!!!!!!!!!!!!!!!!!!!!! END DON'T MOVE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ///////////////////////////////    
