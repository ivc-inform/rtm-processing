...
import com.simplesys.components.{ConstructorForm, PropertyEditorWindow}
...
class ConstructorFormProps extends ChainMasterDetailProps {
    ...
    var updateInBase: ScOption[js.Function2[JSUndefined[ScenariosScr_ScenarioJsonStorage_scenarioDataRecord], JSUndefined[Callback], _]] = ScNone
