...
trait scenarios_PersistenceSnapshot_DebugSnapshot_SemiHandTrait_Remove extends SessionContextSupport with ServletActor {
...
/////////////////////////////// !!!!!!!!!!!!!!!!!!!!!!!!!!!! DON'T MOVE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ///////////////////////////////    
    ...
    val dataSet = PersistenceSnapshot_DebugSnapshotDS(oraclePool)    
/////////////////////////////// !!!!!!!!!!!!!!!!!!!!!!!!!! END DON'T MOVE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ///////////////////////////////    
