...
trait scenarios_Scr_Graph_CopiesJsonStorage_scenario_SemiHandTrait_Remove extends SessionContextSupport with ServletActor {
...
/////////////////////////////// !!!!!!!!!!!!!!!!!!!!!!!!!!!! DON'T MOVE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ///////////////////////////////    
    ...
    val dataSet = Scr_Graph_CopiesJsonStorage_scenarioDS(oraclePool)    
/////////////////////////////// !!!!!!!!!!!!!!!!!!!!!!!!!! END DON'T MOVE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ///////////////////////////////    
